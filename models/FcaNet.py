...
def fcanet50(pretrained=False):
    ...
    if pretrained:
        state_dict = torch.load('/home/dell/backup/code/WakeNet-main/pretrained/fca50.pth')
        model.load_state_dict(state_dict)
    return model
...
def fcanet101(pretrained=False):
    ...
    if pretrained:
        state_dict = torch.load('/home/dell/backup/code/WakeNet-main/pretrained/fca101.pth')
        model.load_state_dict(state_dict)
    return model
